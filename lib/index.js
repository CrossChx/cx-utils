...
var check = exports.check = function check(val) {
  var pause = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];

  if (pause) debugger;else console.log(val);
  return val;
};
